...
|---------|---------|------|
| `api.alexandremariolauret.org` | api-service | 8000 |
| `mlflow.alexandremariolauret.org` | mlflow-service | 5000 |
| `prefect.alexandremariolauret.org` | prefect-service | 4200 |
| `grafana.alexandremariolauret.org` | grafana-service | 3000 |
| `images.alexandremariolauret.org` | image-server-service | 80 |
...
```bash
# Depuis l'UI Prefect
# → https://prefect.alexandremariolauret.org
