...
| Service | Description |
|---------|-------------|
| API | Interface web + endpoints REST |
| MLflow | Tracking des expériences, registre de modèles |
| Prefect | Orchestration des pipelines d'entraînement |
| Grafana | Dashboards de monitoring |
| Images | Serveur d'images statiques |
...
```bash
https://github.com/LaurealDente/csc8605-public.git
cd csc8605
```
