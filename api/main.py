...
""",
    ...
    terms_of_service="https://api.example.com",
    contact={
...
def task_status_ui(
    ...
    heatmap_url = f"http://images.example.com/{outputs_subdir}/{task_id}/{heatmap_name}"
    overlay_url = f"http://images.example.com/{outputs_subdir}/{task_id}/{overlay_name}"
